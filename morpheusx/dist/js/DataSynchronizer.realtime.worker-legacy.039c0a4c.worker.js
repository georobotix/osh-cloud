...
var DataSynchronizerAlgo = /*#__PURE__*/function () {
  function DataSynchronizerAlgo(dataSources) {
    var timerResolution = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 5;
    _classCallCheck(this, DataSynchronizerAlgo);
    this.dataSourceMap = {};
    this.tsRun = undefined;
    this.timerResolution = timerResolution;
    this.interval = null;
    this.datasources = [];
    var _iterator = _createForOfIteratorHelper(dataSources),
      _step;
    try {
  ...
  _createClass(DataSynchronizerAlgo, [{
    key: "removeDataSource",
    value: function removeDataSource(dataSourceId) {
      this.datasources = this.datasources.filter(function (elt) {
        return elt.id !== dataSourceId;
      });
      delete this.dataSourceMap[dataSourceId];
    }
  }, {
    key: "push",
    value: function push(dataSourceId, dataBlocks) {}
  }, {
    ...
    key: "computeNextData",
    value: function computeNextData(tsRef, refClockTime) {
    ...
    key: "checkVersion",
    value: function checkVersion(datasource, dataBlock) {
      throw Error('Should be overridden');
    }
  }, {
    key: "onData",
    value: function onData(dataSourceId, dataBlock) {}
  }, {
    key: "checkStart",
    ...
    key: "setStatus",
    value: function setStatus(dataSourceId, status) {
      throw Error('Should be overridden');
    }
  }, {
    key: "close",
...
var DataSynchronizerAlgoReplay = /*#__PURE__*/function (_DataSynchronizerAlgo) {
  _inherits(DataSynchronizerAlgoReplay, _DataSynchronizerAlgo);
  var _super = _createSuper(DataSynchronizerAlgoReplay);
  function DataSynchronizerAlgoReplay(dataSources) {
    var _this;
    var replaySpeed = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1;
    var startTimestamp = arguments.length > 2 ? arguments[2] : undefined;
    var endTimestamp = arguments.length > 3 ? arguments[3] : undefined;
    var timerResolution = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 5;
    var version = arguments.length > 5 ? arguments[5] : undefined;
    _classCallCheck(this, DataSynchronizerAlgoReplay);
    _this = _super.call(this, dataSources, replaySpeed, timerResolution);
  ...
  _createClass(DataSynchronizerAlgoReplay, [{
    key: "push",
    value: function push(dataSourceId, dataBlocks) {
      ...
      if (dataSourceId in this.dataSourceMap) {
        ...
        (_ds$dataBuffer = ds.dataBuffer).push.apply(_ds$dataBuffer, _toConsumableArray(dataBlocks));
      }
    }
  }, {
    key: "processData",
    value: function processData() {
      ...
      this.interval = setInterval(function () {
        // 1) return the oldest data if any
        while (_this2.computeNextData(_this2.startTimestamp, _this2.clockTimeRef)) {
          _this2.checkEnd();
        }
        _this2.checkEnd();
      }, this.timerResolution);
    ...
    key: "checkVersion",
    value: function checkVersion(dataBlock) {
    ...
    key: "resetDataSource",
    value: function resetDataSource(datasourceId) {
    ...
    key: "removeDataSource",
    value: function removeDataSource(dataSourceId) {
      _get(_getPrototypeOf(DataSynchronizerAlgoReplay.prototype), "removeDataSource", this).call(this, dataSourceId);
    ...
    key: "setEndTimestamp",
    value: function setEndTimestamp(maxTimestamp) {
      this.endTimestamp = maxTimestamp;
    }
  }, {
    key: "setTimeRange",
    value: function setTimeRange(startTimestamp, endTimestamp, replaySped) {
...
var DataSynchronizerAlgoRealtime = /*#__PURE__*/function (_DataSynchronizerAlgo) {
  _inherits(DataSynchronizerAlgoRealtime, _DataSynchronizerAlgo);
  var _super = _createSuper(DataSynchronizerAlgoRealtime);
  function DataSynchronizerAlgoRealtime() {
    _classCallCheck(this, DataSynchronizerAlgoRealtime);
    return _super.apply(this, arguments);
  }
  _createClass(DataSynchronizerAlgoRealtime, [{
    key: "push",
    value: function push(dataSourceId, dataBlocks) {
      var _ds$dataBuffer;
      if (dataBlocks.length === 0) {
    ...
    value: function computeNextData(tsRef, refClockTime) {
      ...
      // compute next data to return
      for (var _currentDsId in this.dataSourceMap) {
        currentDs = this.dataSourceMap[_currentDsId];
...
/******/ })()
;
//# sourceMappingURL=DataSynchronizer.realtime.worker-legacy.039c0a4c.worker.js.map